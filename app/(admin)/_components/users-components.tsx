...
import { Button, FormControl, Label, Select, SelectOption } from "@/features/admin/drizzle-admin/drizzle-ui";
import {
  AdminPageNav,
  AdminPageNavProps,
  AdminRowNav,
  AdminRowNavProps,
  CustomFormControl,
} from "@/features/admin/drizzle-admin/types";
...
export const UserRoleCustomFormControl: CustomFormControl = (props) => {
  return (
    <FormControl>
      <Label>Role</Label>
      <Select name="role" defaultValue={props.value as string | undefined}>
