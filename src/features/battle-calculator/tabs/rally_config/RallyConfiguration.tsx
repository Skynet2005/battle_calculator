...
import { getAllHeroesForSelect, getHeroesByClassForSelect, getHeroExpeditionSkills, getHeroSkillLevelOptions, getTroopDefinitionOptions } from '@/domain/battle/data-selectors';
...
import { buildConfigForSide, DEFAULT_TROOP_MIX } from '@/domain/rally/rally-config';
import type { FireCrystalLevel, RallyConfiguration, RallyHero, TroopConfiguration, TroopMixConfig, TroopTier, TroopType } from '@/shared/types';
