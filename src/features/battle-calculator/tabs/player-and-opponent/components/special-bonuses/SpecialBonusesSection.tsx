      ...
      <div className="card info-card mb-4">
        ...
        <div className="grid">
          <div className="form-group">
            <label aria-label="VIP Prestige Level">VIP Prestige Level</label>
            <select aria-label="VIP Prestige Level" value={vipSelectValue} onChange={(e) => onVipChange(e.target.value)}>
            ...
            <div className="grid">
              {STAT_KEYS.map((stat) => (
                <div key={stat} className="form-group">
                  <label aria-label={`${stat.charAt(0).toUpperCase() + stat.slice(1)} (%)`}>{stat.charAt(0).toUpperCase() + stat.slice(1)} (%)</label>
                  <input
                    type="number"
                    aria-label={`${stat.charAt(0).toUpperCase() + stat.slice(1)} (%)`}
                    step="0.1"
