...
import type { CapacityReport, MixTroopCounts } from '../types';
import { TROOP_TYPES } from '../types';
import { formatPercent } from '@/features/battle-calculator/tabs/results/utils/format';
import { TroopMixQuickEditor } from '@/features/battle-calculator/tabs/results/sections/TroopMixQuickEditor';
