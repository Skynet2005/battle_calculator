...
import { FinalStatsMatrix } from '@/features/battle-calculator/tabs/results/sections/FinalStatsMatrix';
import { SidePanel } from '@/features/battle-calculator/tabs/results/sections/SidePanel';
...
import type { BattleSideContext, CapacityReport, MixTroopCounts } from '../types';
