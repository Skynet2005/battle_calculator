...
import type { BattleReport, TroopCounts as CombatTroopCounts } from '@/domain/battle/engine/types';
...
function averageStats(stats: Record<string, { attack: number; defense: number; lethality: number; health: number }> | null): { attack: number; defense: number; lethality: number; health: number } | null {
