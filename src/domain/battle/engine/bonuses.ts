...
import { TROOP_TYPE_VALUES } from "./types";

/** Single source of truth for simulation engine troop types (PascalCase). Re-exported from types. */
export const TROOP_TYPES: readonly TroopType[] = TROOP_TYPE_VALUES;
