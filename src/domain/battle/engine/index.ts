 ...
 *
 * @example
 * import { simulateBattle, BattleConfig, TroopType } from "@/domain/battle/engine";
 */
...
export type {
  ...
  // Bonuses (AdditiveBonuses comes from @/domain/battle/calculations to avoid duplicate export)
  SpecialBonuses,
