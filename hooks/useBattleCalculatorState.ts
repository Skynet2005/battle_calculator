...
} from '../lib/battle/index';
import { simulateBattleFromUI } from '../lib/combat/adapter';
import { saveProfile } from '../lib/profile-storage';
import type { FightResult } from '../lib/rally/combat-fight';
import { buildFighterSnapshot, totalTroops, type FighterSnapshot } from '../lib/rally/combat-fighter';
import type { SideBaseStats } from '../lib/rally/combat-types';
import { calculateRallyBonuses, extractJoinerBonuses } from '../lib/rally/rally-bonus-extractor';
...
export function useBattleCalculatorState() {
  ...
  const playerBaseStats: SideBaseStats = currentProfile
    ? buildSideBaseStats(
  ...
  const opponentBaseStats: SideBaseStats = currentProfile?.opponent
    ? buildSideBaseStats(
