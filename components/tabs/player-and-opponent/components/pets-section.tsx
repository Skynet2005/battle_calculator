...
import type { BasicBonuses, MultiplicativeBonuses } from '@/lib/battle/calculations';
import { getColorTierBonuses } from '@/lib/battle/data/pets/color-tier-bonuses';
  ...
  return (
    <>
      ...
      <div className="card info-card mb-4">
        ...
        <div className="grid">
          <div className="form-group">
            <label>Infantry Lethality (%)</label>
            <input
              type="number"
              step="0.01"
      ...
      <div className="card info-card mb-4">
        ...
        <div className="grid">
          <div className="form-group">
            <label>Marksman Lethality (%)</label>
            <input
              type="number"
              step="0.01"
      ...
      {Object.entries(PETS_DATA).map(([petName, pet]) => {
        ...
        return (
          <div key={petName} className="card info-card">
            ...
            <div className="form-group">
              <label>Skill Level (0-{maxLevel})</label>
              <select
                value={currentLevel}
                onChange={e => {
