...
//           <ResearchBonusesDisplay basicBonuses={basicBonuses} />
...
//               setResearchSelections={setResearchSelections}
//             />
//           ))}
//         </div>
//       )}
...
//           <WarAcademyBonusesDisplay warAcademySelections={warAcademySelections} />

//           {/* War Academy Tech by Troop Type */}
//           {(['infantry', 'lancer', 'marksman'] as const).map(troopType => (
//             <WarAcademyTroopSection
//               key={troopType}
//               troopType={troopType}
//               warAcademyData={warAcademyData}
//               warAcademySelections={warAcademySelections}
//               setWarAcademySelections={setWarAcademySelections}
//             />
//           ))}
//         </div>
//       )}
...
// function ResearchBonusesDisplay({ basicBonuses }: { basicBonuses: BasicBonuses }) {
...
// function BonusStatsGrid({ bonuses }: { bonuses: { attack: number; defense: number; lethality: number; health: number } }) {
//   return (
//     <div className="stat-grid">
//       <div>
//         <div className="stat-label normal-case">Attack</div>
//         <div className="stat-value text-xl">
//           {bonuses.attack > 0 ? '+' : ''}{bonuses.attack.toFixed(2)}%
//         </div>
//       </div>
//       <div>
//         <div className="stat-label normal-case">Defense</div>
//         <div className="stat-value text-xl">
//           {bonuses.defense > 0 ? '+' : ''}{bonuses.defense.toFixed(2)}%
//         </div>
//       </div>
//       <div>
//         <div className="stat-label normal-case">Lethality</div>
//         <div className="stat-value text-xl">
//           {bonuses.lethality > 0 ? '+' : ''}{bonuses.lethality.toFixed(2)}%
//         </div>
//       </div>
//       <div>
//         <div className="stat-label normal-case">Health</div>
//         <div className="stat-value text-xl">
//           {bonuses.health > 0 ? '+' : ''}{bonuses.health.toFixed(2)}%
//         </div>
//       </div>
//     </div>
//   );
...
// }: {
//   category: string;
//   researchSelections: Record<string, Record<string, number>>;
//   setResearchSelections: (selections: Record<string, Record<string, number>>) => void;
// }) {
//   const tierLabels = getResearchTierLabels(category);
...
// function WarAcademyBonusesDisplay({ warAcademySelections }: { warAcademySelections: Record<string, number> }) {
//   const academyBonuses = getWarAcademyBonuses(warAcademySelections);
//   const hasBonuses =
...
// function WarAcademyTroopSection({
//   troopType,
//   warAcademyData,
//   warAcademySelections,
...
//   return (
//     <div className="card info-card mb-8">
